...
### Тестовое задание на стажировку в "Северсталь" по направлению "разработка и программирование". Номер задания - 6.
# Порядок запуска:
...
***Максимальный упор сделан на архитектуру приложения***. Реализована слоистая архитектура вместе с паттернами *Repository* и *Unit of Work*.
